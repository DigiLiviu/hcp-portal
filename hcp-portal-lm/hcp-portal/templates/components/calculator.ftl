<div class="calculator">
  ...
  [#if content.multiplier?has_content]
    <form class="cmp-calculator" data-multiplier="${content.multiplier}">
      <input name="calculator-input"/>
      <button name="calculate" type="button">Calc</button>
      <span class="result">Not calculated</span>
    </form>
    <script>
      calculator(${content.multiplier})
    </script>
  [/#if]
